      ...
      <main className="flex-1">
        <div className="mx-auto max-w-4xl px-4 py-10">
          ...
          <form onSubmit={submit} className="space-y-3">
            ...
            <textarea name="message" placeholder="Message" className="w-full p-2 border rounded h-32" required />
            <div>
              <button className="px-4 py-2 bg-red-600 text-white rounded" disabled={loading}>{loading ? "Sending..." : "Send"}</button>
            </div>
          </form>
